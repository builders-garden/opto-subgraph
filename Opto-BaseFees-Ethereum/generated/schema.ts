...
export class Block extends Entity {
  ...
  get blobBaseFee(): BigInt | null {
    let value = this.get("blobBaseFee");
    if (!value || value.kind == ValueKind.NULL) {
      return null;
    } else {
      return value.toBigInt();
  ...
  set blobBaseFee(value: BigInt | null) {
    if (!value) {
      this.unset("blobBaseFee");
    } else {
      this.set("blobBaseFee", Value.fromBigInt(<BigInt>value));
    }
  }
...
export class FeeAggregator extends Entity {
  ...
  get blob_average_daily(): BigInt | null {
    let value = this.get("blob_average_daily");
    if (!value || value.kind == ValueKind.NULL) {
      return null;
    } else {
      return value.toBigInt();
  ...
  set blob_average_daily(value: BigInt | null) {
    if (!value) {
      this.unset("blob_average_daily");
    } else {
      this.set("blob_average_daily", Value.fromBigInt(<BigInt>value));
    }
  }
}
