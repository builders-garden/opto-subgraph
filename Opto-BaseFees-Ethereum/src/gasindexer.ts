...
import { Transfer } from "../generated/EthGasFetcher/USDC";
import { Block, FeeAggregator } from "../generated/schema";
import { BlobBaseFeeFetcher } from "../generated/EthGasFetcher/BlobBaseFeeFetcher"
...
const ethGetBlobBaseFeeContract = "0x98A1bbEd64283ac8E7E09D25e5D40EDDa41Ff429"
let contract = BlobBaseFeeFetcher.bind(Address.fromString(ethGetBlobBaseFeeContract));
...
export function handleTransfer(event: Transfer): void {
  ...
  if (!block) {
      ...
      if (!contract.try_getBlobBaseFeeYul().reverted){
        block!.blobBaseFee = contract.getBlobBaseFeeYul().times(BigInt.fromI32(1000000000));
      }
      block.save();
